...
import { getPlayerScore, setPlayerScore, showActionBar, getPlayerData, giveItem, } from "../utils/player/index";
...
const updateBalance = async (player, amount) => {
    ...
    try {
        const response = await httpReq({
            method: "post",
            url: `${variables.get("BASE_URL")}/users/${playerData.xuid}/update_balance?type=transaction`,
            headers: {
